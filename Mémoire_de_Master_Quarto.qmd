...
kable(splits_variete %>% select(Country_Name, arabica_disp, pct_monde_arabica,
      ...
      booktabs  = TRUE,
      col.names = c("Country", "Arabica (1000 bags, % of country)",
                    "% of 14-country Arabica total",
                    "Robusta (1000 bags, % of country)",
                    "% of 14-country Robusta total")) %>%
  kable_styling(bootstrap_options = c("striped", "hover"),
                font_size = 11, full_width = TRUE)
```
...
The scree plot indicates that PC1 captures 36.0% of the total variance in the predictor space, and five components are needed to cross the conventional 80% threshold. This relatively slow accumulation confirms that the predictor set is genuinely multidimensional rather than dominated by a single underlying factor, even though strong pairwise collinearity exists among specific subsets of variables, as shown in the correlation matrix above.
